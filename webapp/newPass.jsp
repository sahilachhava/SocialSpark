                ...
                <div class="column is-6">
                    ...
                    <div class="hero-body">
                        <div class="form-wrapper">
                            ...
                            <!--Form-->
                            <form action="./ForgotPassword" method="post" id="newPassForm">
                                <div class="login-form">
                                    <div class="field">
                                        <div class="control">
                                            <input class="input email-input" type="password" name="pass" id="pass" placeholder="New Password" required>
                                    ...
                                    <div class="field">
                                        <div class="control">
                                            <input class="input password-input" type="text" name="cpass" id="cPass" placeholder="Confirm Password" required>
                                            <div class="input-icon">
                                                <i data-feather="lock"></i>
                                            </div>
                                        </div>
                                    </div>
                                    <input type="text" name="actionType" value="change" hidden="" />
                                    <div class="field">
                                        <div class="control">
                                            <a class="button is-solid primary-button raised is-rounded is-fullwidth submit-btn">Change Password</a>
                                        </div>
                                    </div>
                                </div>
                                </form>
